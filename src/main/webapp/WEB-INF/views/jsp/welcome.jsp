...
<script>
    jQuery(document).ready(function ($) {
        ...
        $("#search-form").submit(function (event) {
            ...
            fetchAPIcall();
            searchViaAjax();
            drawFoldChangeExpressionPlot();
            plot();
            gitHubDetails(narendraraghu);
    ...
    function drawFoldChangeExpressionPlot() {
        var search = {}
        search["username"] = $("#username").val();
        search["email"] = $("#email").val();
        ...
        $.ajax({
            type: 'post',
            contentType: "application/json",
            url: '${home}data/getFoldChangeExpressionPlotResult',
            data: JSON.stringify(search),
            dataType: 'json',
            timeout: 60000,
            success: function (data) {
    ...
    function fetchAPIcall() {
        ...
        var polls = 0;
        var url = "${home}get/api/fetchAPIcall";
